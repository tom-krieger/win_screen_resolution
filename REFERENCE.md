...
* [`win_screen_resolution::set_registry_values`](#win_screen_resolutionset_registry_values): Registry settings
...
### <a name="win_screen_resolutionset_registry_values"></a>`win_screen_resolution::set_registry_values`
...
The following parameters are available in the `win_screen_resolution::set_registry_values` defined type:
